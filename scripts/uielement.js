/**
	****UI Element Documentation****
	...
	function UILabel (text, align = "center",?font_size)
	...
	function UIHyperlink (text, align, url)
...
UIElement.prototype.default_colour = "#e8e6e1";
UIElement.prototype.darker_colour = "#d6d4ce";
UIElement.prototype.lighter_colour = "#fffcf5";
...
UIElement.prototype.setFontSize = function(font_size)
{
	if(font_size > 0) this.font_size = font_size;
}
...
UIElement.prototype.handle_mouseup = function(mouseX, mouseY)
{
	...
	if(this.isInBounds(mouseX,mouseY) && this.mousedown)
	{
		...
		if(this.handle_mouseclick) this.handle_mouseclick(mouseX, mouseY);
	}
	else 
	{
		this.unfocus();
...
UIElement.prototype.handle_resize = function(width,height)
{
	// handle self FIRST in case children need it
	...
	if(this.children)
	{
		...
		{
			var child = this.children[index];
			child.handle_resize(width, height);
		}
	}
}
...
UITabbedPanel.prototype.resize = function(width,height)
{
	UIElement.prototype.resize.call(this,width,height);
	this.tab_bar.resize(width,this.TAB_HEIGHT);
	this.content_panel.resize(width,this.height - this.TAB_HEIGHT);
}
// Scrolling, finally!
function UIScrollPanel (x,y,width,height,max_height)
{
...
UIWindow.prototype.resize = function(width,height)
{
	UIElement.prototype.resize.call(this,width,height);
	this.title_bar.attach(this);
	this.content_panel.resize(this.width,this.height - UIWindow.prototype.TITLE_BAR_HEIGHT);
}
/**
	MENUBUTTONS
